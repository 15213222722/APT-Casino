...
export const recentBigWins = [
      { player: "CryptoMiner", amount: "1,217.50 OCT", time: "3m ago", config: "10 mines" },
    { player: "DiamondHands", amount: "892.50 OCT", time: "10m ago", config: "5 mines" },
    { player: "GemHunter", amount: "653.00 OCT", time: "22m ago", config: "3 mines" },
    { player: "RiskTaker", amount: "437.00 OCT", time: "45m ago", config: "3 mines" },
    { player: "TreasureSeeker", amount: "381.50 OCT", time: "1h ago", config: "1 mine" }
];
